...
#pragma config(Motor,  port1,           LauncherLeftInside, tmotorVex393_HBridge, openLoop, encoderPort, I2C_6)
...
#pragma config(Motor,  port10,          LauncherRightInside, tmotorVex393_HBridge, openLoop, reversed, encoderPort, I2C_5)
